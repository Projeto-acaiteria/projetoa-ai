...
function buildPanels(f: Features): PanelDef[] {
  ...
  if (f.hasTables) p.push({ eyebrow: "Cardápio na mesa", EyeIcon: IconTable, title: "O cliente pede da mesa.", accent: "Sai impresso na estação.", desc: "O cliente escaneia o QR da mesa, monta o pedido e envia — sem chamar ninguém. O drink sai na impressora do bar e o prato na da cozinha, com o número da mesa grande e a observação do cliente. Pela mesma tela ele chama o garçom ou pede a conta, e o aviso aparece na hora no painel. Tudo opcional: se preferir, o cardápio fica só pra consulta e quem lança é o garçom.", pills: ["QR por mesa", "Mesa e observação no cupom", "Chamar garçom", "Pedir a conta", "Opcional"], mock: <ScreenMock title="Mesa 12 · pelo QR" badge="bar" rows={[{ label: "2× Caipirinha", value: "OBS: pouco gelo", on: true }, { label: "Chamar garçom" }, { label: "Pedir a conta" }]} footer={{ label: "Saiu na impressora", value: "BAR" }} /> });
