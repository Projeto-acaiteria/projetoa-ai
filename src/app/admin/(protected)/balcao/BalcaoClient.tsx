  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-bg-elevated p-5 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <input autoFocus type="number" inputMode="numeric" value={grams} onChange={(e) => setGrams(e.target.value)} placeholder="ex: 480" className="mt-1 w-full rounded-xl border border-line bg-bg-base px-4 py-3 text-lg font-bold text-ink outline-none focus:border-brand-600" />
