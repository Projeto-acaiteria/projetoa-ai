...
export default async function PedidosPage() {
  ...
  return (
    <>
      ...
      />
      <PedidosClient storeName={store.name} storeSlug={cur?.slug ?? ""} endereco={store.endereco} cnpj={store.cnpj} tel={store.whatsapp} cupomRodape={store.cupomRodape} storeId={cur?.id ?? null} />
    </>
  );
}
