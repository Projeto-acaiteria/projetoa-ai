...
export default function PedidosClient({ storeName, storeSlug, endereco, cnpj, tel, cupomRodape }: { storeName: string; storeSlug: string; endereco: string; cnpj: string; tel: string; cupomRodape: string }) {
