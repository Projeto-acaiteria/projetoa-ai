...
export default async function MesasPage() {
  ...
  if (isRelacional) {
    ...
    return <>{header}<MesasBarClient categories={categories} coverShow={coverShow} staff={staff} storeName={store.name} machines={machines} endereco={store.endereco} cnpj={store.cnpj} tel={store.whatsapp} cupomRodape={store.cupomRodape} canClose={canClose} selfWaiterId={selfWaiterId} offlineEnabled={!!cfg?.offline_enabled} storeId={storeId} /></>;
  }
