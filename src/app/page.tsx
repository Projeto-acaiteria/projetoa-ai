...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#1e1b4b] to-[#0f172a] text-white">
      {/* topo */}
      ...
      <section className="mx-auto max-w-3xl px-5 pb-10 pt-12 text-center sm:pt-20">
        ...
        <h1 className="mt-5 text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl">
          O sistema completo do seu <span className="text-indigo-300">food service</span>.
        </h1>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link href="/cadastro" className="w-full rounded-xl bg-indigo-600 px-7 py-3.5 text-center font-bold transition hover:bg-indigo-500 sm:w-auto">Criar minha loja grátis</Link>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16">
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-white/5 p-6 text-center">
          ...
          <Link href="/cadastro" className="mt-5 inline-block rounded-xl bg-indigo-600 px-7 py-3 font-bold transition hover:bg-indigo-500">Criar minha loja grátis</Link>
        </div>
      </section>
