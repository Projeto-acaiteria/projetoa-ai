  ...
  try {
    ...
    return NextResponse.json({
      ...
      orders: full.orders.map((o) => ({
        items: o.items.map((i) => ({ name: i.name, sizeLabel: i.size_label, qty: i.qty, unitPriceCents: i.unit_price_cents, station: o.station, note: i.note ?? null, mods: i.mods ?? null })),
      })),
