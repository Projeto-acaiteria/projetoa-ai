...
export function stationTicketHtml(d: StationTicketData): string {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    *{font-family:'Courier New',monospace;color:#000;margin:0}
    body{width:72mm;padding:2mm 12mm 2mm 4mm;line-height:1.3;font-weight:700}
...
export function leituraXHtml(d: LeituraXData): string {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    *{font-family:'Courier New',monospace;color:#000;margin:0}
    body{width:72mm;padding:2mm 12mm 2mm 4mm;font-size:14px;line-height:1.45;font-weight:700}
