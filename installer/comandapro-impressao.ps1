...
# --- 4. reinicia o QZ pra carregar o override.crt ---
Get-Process "qz-tray" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
...
Write-Host ""
$url = Read-Host "[6/6] URL do sistema p/ atalho Chrome kiosk-printing (Enter pra pular)"
if ($url) {
